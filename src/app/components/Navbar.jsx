...
const Navbar = () => {
  ...
  return (
    <div className="navbar fixed top-0 left-0 right-0 backdrop-blur-xl bg-black bg-opacity-60 md:bg-opacity-10 shadow-xl shadow-[#0669AD]/100 transition-all delay-100 text-white px-0 md:px-10">
      <nav>
        <div className="flex flex-col px-8 sm:px-14 md:px-18 py-2">
          <div className="flex justify-between items-center py-5">
            <p className="pb-1 text-2xl sm:text-3xl md:text-3xl">
              Sevde Pehlivan
            </p>
